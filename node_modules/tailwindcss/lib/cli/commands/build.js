...
function build(inputFile, configFile, outputFile) {
  ...
  return new Promise((resolve, reject) => {
    (0, _postcss2.default)([(0, _2.default)(configFile), _autoprefixer2.default]).process(css, {
      from: inputFile,
      to: outputFile
...
function run(cliParams, cliOptions) {
  return new Promise((resolve, reject) => {
    ...
    const buildPromise = outputFile ? buildToFile(inputFile, configFile, outputFile, startTime) : buildToStdout(inputFile, configFile, outputFile);
